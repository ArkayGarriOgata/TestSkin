...
$(document).ready(function () {
			...
			// specify the columns
		columnDefs = [
			{ headerName: "Product Code", field: "product_code", sortable: true, filter: true, width: 140, pinned: "left"  },
			{ headerName: "Product Line", field: "product_line", sortable: true, filter: true, width: 140 },
			{ headerName: "Description", field: "description", sortable: true, filter: true, width: 240 },
			{ headerName: "On Hand", field: "qty_onhand", sortable: true, filter: true, width: 100, cellStyle: { textAlign: 'center' } },
			{ headerName: "Released", field: "qty_wip", sortable: false, filter: true, width: 100, cellStyle: { textAlign: 'center' } }
		];
