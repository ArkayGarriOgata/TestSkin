//was ams_trigger_sync_record ("trigger_BillOfLading")
//need to have finer control on the bol's trigger
...
If (<>Sync_Activated)
	...
	$0:=trigger_BillOfLading  //do normal trigger stuff
	//End if 
