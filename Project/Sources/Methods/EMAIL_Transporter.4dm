//%attributes = {}
// _______
// Method: EMAIL_Transporter   ({ subject; bodyHdr; body; to; attachments[]; reply-to; fromNOTUSED; header; cc-to }) ->
...
$len:=Length:C16($mail_o.to)
If ($mail_o.to[[$len]]=$comma)  //make it end without delimitor
	$mail_o.to:=Substring:C12($mail_o.to; 1; $len-1)
End if 
