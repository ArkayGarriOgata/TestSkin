...
//Method: wms_api_Get_Same_From_To - Created v0.1.0-JJG (05/16/16)
If (<>fDebug)
	DODEBUG(Current method name:C684)
End if 
// new method for MySQL vs 4D

C_LONGINT:C283($0; $xlNumRecs)
$xlNumRecs:=$0

If (<>fWMS_Use4D)
	$xlNumRecs:=WMS_API_4D_getSameFromTo
Else 
	$xlNumRecs:=wms_api_MySQL_Get_Same_From_To
End if 

$0:=$xlNumRecs

If (False:C215)  //v0.1.0-JJG (05/16/16) - moved to WMS_api_MySQL_Get_Same_From_To
	//  // ----------------------------------------------------
	//  // User name (OS): mel
