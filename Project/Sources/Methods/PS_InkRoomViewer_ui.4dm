//%attributes = {}
// _______
// Method: PS_InkRoomViewer_ui   ( ) ->
// By: MelvinBohince @ 03/24/22, 13:48:23
// Description
// based on PS_PrePressViewer_ui with ink related criteria
// ----------------------------------------------------
...
Else   //init
	...
	$form_o.params:=New object:C1471("oneWeek"; False:C215; "priorityUnder100"; False:C215; "needInk"; True:C214; "showCompleted"; False:C215; "released"; True:C214)
	...
	$winRef:=OpenFormWindow(->[ProductionSchedules:110]; "InkViewer")
	DIALOG:C40([ProductionSchedules:110]; "InkViewer"; $form_o)
