...
//fCalcPress_Sub called by sRunEstimate
//based on fCalcPress
//3/15/95 upr 66
...
If ([Cost_Centers:27]ID:1="415")  //                                  change in 1/1/94 stds
...
Else 
	...
	End if 
	If ($caliper>Round:C94(0.022; 4))
		[Estimates_Machines:20]RunningRate:31:=[Estimates_Machines:20]RunningRate:31*(1-([Cost_Centers:27]RS_reduction2:54/100))
	End if 
End if 
