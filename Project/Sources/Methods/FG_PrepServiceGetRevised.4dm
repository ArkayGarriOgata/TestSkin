//%attributes = {}
// Method: FG_PrepServiceGetRevised ({controlnumber}) -> Sum([PrepCharges]PriceActual)
// ----------------------------------------------------
...
//see also FG_PrepServiceGetQuote
// Updates:
...
If (Records in selection:C76([Prep_Charges:103])>0)
	$0:=Round:C94(Sum:C1([Prep_Charges:103]PriceRevised:11); 2)
Else 
	$0:=0
End if 
