...
// ----------------------------------------------------
// User name (OS): mel
// Date and time: 03/26/08, 14:19:26
// ----------------------------------------------------
// Method: Arden_DeliveryScheduleCompare
// ----------------------------------------------------
// based on: PnG_DeliveryScheduleCompare () -> 
// ----------------------------------------------------
...
currentLocation:=Arden_GetCPNsByLocation  // start with all of them
...
While (nextItem<iCnt)  //these can change by user's actions
	...
	If (currentLocation#locationChanged)
		currentLocation:=Arden_GetCPNsByLocation(locationChanged)
		nextItem:=1
		iCnt:=Size of array:C274(aCPN)
