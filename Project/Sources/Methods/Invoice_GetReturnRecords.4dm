...
//PM:  Invoice_GetReturnRecords  4/16/99  MLB
...
//REDUCE SELECTION([Bills_of_Lading];0)`• mlb - 8/7/02  11:03
...
If ([Finished_Goods:26]ProductCode:1#[Customers_Order_Lines:41]ProductCode:5)
	qryFinishedGood([Customers_Order_Lines:41]CustID:4; [Customers_Order_Lines:41]ProductCode:5)  //•4/15/99  MLB 
