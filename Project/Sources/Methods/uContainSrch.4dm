//%attributes = {}
//(P) uContainSrch: search equal condition
...
Case of 
	: ((sSlctType="N") | (sSlctType="R") | (sSlctType="L"))  //Number
		QUERY:C277(zDefFilePtr->; aSlctField{zSelectNum}->=Num:C11(sCriterion4))
		
	: (sSlctType="A")  //Alphanumeric
		QUERY:C277(zDefFilePtr->; aSlctField{zSelectNum}->=("@"+sCriterion4+"@"))
	...
	: (sSlctType="D")  //Date
		$Text1:=sCriterion4  //•042199  MLB fix cs's code
