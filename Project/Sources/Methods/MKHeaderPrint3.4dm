...
//(p) MkHeaderPrint3($Print2Disk;$CurrentBill;$Path)
...
If ($Print2Disk)  //if this report is being printed to disk
	...
	If ($0)
		...
		xText:=xText+t2b+$Cr
		xText:=xText+"Release"+$T+"Release"+($T*4)+"Price"+$T+"Qty"+$T+"Qty"+$T+"Qty"+$T+"Qty"+$T+"QA"+$T+"B&H"+$t+"Qty"+$T+"Calc'ed Avail"+$T+"Actual"+$T+"Bal Due"+$T+"Customer"+$T+"Customer"+$T+"Arkay"+$T+"Calc'ed"+$T+"Last Ship"+$T+"Production"+$Cr
		xText:=xText+"Now"+$T+"______"+$T+"P.O. #"+$T+"Item #"+$T+"Description"+$t+"per 1000"+$T+"Ordered"+$T+"W % Over"+$T+"Prod"+$T+"Shipped"+$T+"Hold"+$t+"Qty"+$T+"Pay Use"+$T+"to Ship"+$T+"On Hand"+$T+"w/ Overage"+$T+"Resp"+$T+"Resp $"+$T+"Resp"+$T+"Excess"+$T+"Date"+$T+"Date"+$Cr
