//%attributes = {}
// -------
// Method: RM_Issue_Auto_Corrugate   ( ) ->
// By: Mel Bohince @ 05/15/17, 08:18:06
// Description
// 
// ----------------------------------------------------
...
If (<>Auto_Corr_Percent>0)
	//utl_LogfileServer (<>zResp;[Job_Forms]JobFormID+" Request: "+String(<>Auto_Corr_Percent)+"% of selling price for corrugate";"AutoIssue.log")
	...
	QUERY:C277([Raw_Materials_Transactions:23];  & ; [Raw_Materials_Transactions:23]Commodity_Key:22="06@")
	If (Records in selection:C76([Raw_Materials_Transactions:23])=0)  //create one
		...
		If ($highest_posible_rev>0)  // Modified by: Mel Bohince (6/7/18) 
			...
			[Raw_Materials_Transactions:23]Raw_Matl_Code:1:="AutoIssueCorrugate"
			...
			[Raw_Materials_Transactions:23]ActExtCost:10:=($highest_posible_rev*<>Auto_Corr_Percent)*[Raw_Materials_Transactions:23]Qty:6
			//utl_Logfile ("AutoIssue.log";"   "+[Job_Forms]JobFormID+"  "+String($highest_posible_rev)+" revenue results in "+String(($highest_posible_rev*<>Auto_Ink_Percent))+" calc'd cost")
			...
			[Raw_Materials_Transactions:23]Commodity_Key:22:="06-AutoCorrugate"
	...
	Else 
		//  utl_Logfile ("AutoIssue.log";"   "+[Job_Forms]JobFormID+"  already auto-issued")
	End if 
...
Else 
	//utl_Logfile ("AutoIssue.log";[Job_Forms]JobFormID+" Manual")
End if 