...
Case of 
	...
	: (Form event code:C388=On Display Detail:K2:22)
		...
		r5:=r5+[Customers_ReleaseSchedules:46]Sched_Qty:6  //set up for next during phase of same cpn
		...
		End if 
		RELATE ONE:C42([Job_Forms_Items:44]JobForm:1)  //`get job type
