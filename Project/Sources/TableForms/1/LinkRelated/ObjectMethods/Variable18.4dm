...
Case of 
	: ((sLinkWhat="Contact-Cust") | (sLinkWhat="Address-Cust"))
		...
		QUERY:C277([Customers:16]; [Customers:16]ID:1=sABCTABID+"@")
	...
	: ((sLinkWhat="Cust-Contact") | (sLinkWhat="Vend-Contact"))
		QUERY:C277([Contacts:51]; [Contacts:51]ContactID:1=sABCTABID+"@")
	...
	: (sLinkWhat="Cust-Address")
		QUERY:C277([Addresses:30]; [Addresses:30]ID:1=sABCTABID+"@")
	...
	: (sLinkWhat="Contact-Vend")
		QUERY:C277([Vendors:7]; [Vendors:7]ID:1=sABCTABID+"@")
