If (aMfgPlant#0)
	[Job_Forms:42]Run_Location:55:=aMfgPlant{aMfgPlant}
	...
	Case of 
		...
		: ([Job_Forms:42]Run_Location:55="Roanoke") | ([Job_Forms:42]Run_Location:55="Hauppauge")
			...
			If ($Wrong#"")
				ALERT:C41("There were machines budgeted for this Jobform, which are NOT located in "+[Job_Forms:42]Run_Location:55+Char:C90(13)+"These Machines are:"+Char:C90(13)+$Wrong+Char:C90(13)+"Please insure that you have the correct machines budgeted.")
			End if 
