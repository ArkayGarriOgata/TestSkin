...
If (ok=1) & ($Loc#"")
	...
	QUERY:C277([Finished_Goods_Transactions:33];  & ; [Finished_Goods_Transactions:33]viaLocation:11=$Loc)
	If (Records in selection:C76([Finished_Goods_Transactions:33])=0)
		uConfirm("FG Transfer records do not exist for 'From' Location "+$Loc; "OK"; "Help")
		rTotXfer:=0
	Else 
