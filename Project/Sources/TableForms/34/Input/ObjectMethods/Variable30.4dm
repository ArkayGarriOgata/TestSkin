...
//°5/3/95 upr 1487
//•053195  MLB  UPR 1619
// Modified by: Mel Bohince (11/11/15) `old workflow no longer followed 

If (asChgStat#0)
	Case of   //old status being:
		: (True:C214)  // Modified by: Mel Bohince (11/11/15) `old workflow no longer followed 
		...
		: ([Customers_Order_Change_Orders:34]ChgOrderStatus:20="Pricing@")
			Case of 
				: (asChgStat{asChgStat}="New")
					// If (Old(ChgOrderStatus)#"New")    `°5/3/95 upr 1487
					// BEEP
					...
					//  End if 
				: (asChgStat{asChgStat}="Open@")
					//  If (Old(ChgOrderStatus)#"Open@")    `°5/3/95 upr 1487
					//  BEEP
		...
		: ([Customers_Order_Change_Orders:34]ChgOrderStatus:20="Proceed@")
			If (Old:C35([Customers_Order_Change_Orders:34]ChgOrderStatus:20)="Proceed@")
				BEEP:C151
	...
	//ChgOrderStatus:=asChgStat{asChgStat}
End if 