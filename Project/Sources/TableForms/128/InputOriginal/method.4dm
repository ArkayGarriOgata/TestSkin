...
Case of 
	: (Form event code:C388=On Load:K2:1)
		...
		cb4:=Num:C11(Position:C15("GVR"; [Finished_Goods_Color_SpecMaster:128]stockPrecoat:8)>0)
		
		cb6:=Num:C11(Position:C15("O/P"; [Finished_Goods_Color_SpecMaster:128]finishType:11)>0)
		cb7:=Num:C11(Position:C15("U/V"; [Finished_Goods_Color_SpecMaster:128]finishType:11)>0)
		cb8:=Num:C11(Position:C15("W/B"; [Finished_Goods_Color_SpecMaster:128]finishType:11)>0)
		...
		cb10:=Num:C11(Position:C15("Inline"; [Finished_Goods_Color_SpecMaster:128]finishProcess:12)>0)
		cb11:=Num:C11(Position:C15("Offline"; [Finished_Goods_Color_SpecMaster:128]finishProcess:12)>0)
		cb12:=Num:C11(Position:C15("Spot"; [Finished_Goods_Color_SpecMaster:128]finishProcess:12)>0)
		cb13:=Num:C11(Position:C15("Solid"; [Finished_Goods_Color_SpecMaster:128]finishProcess:12)>0)
		
		rb5:=Num:C11(Position:C15("None"; [Finished_Goods_Color_SpecMaster:128]finishGlossLevel:13)>0)
		rb1:=Num:C11(Position:C15("Dull"; [Finished_Goods_Color_SpecMaster:128]finishGlossLevel:13)>0)
		rb2:=Num:C11(Position:C15("Satin"; [Finished_Goods_Color_SpecMaster:128]finishGlossLevel:13)>0)
		rb3:=Num:C11(Position:C15("Semi"; [Finished_Goods_Color_SpecMaster:128]finishGlossLevel:13)>0)
		rb4:=Num:C11(Position:C15("Gloss"; [Finished_Goods_Color_SpecMaster:128]finishGlossLevel:13)>0)
		
		arb1:=Num:C11(Position:C15("None"; [Finished_Goods_Color_SpecMaster:128]finishStamps:14)>0)
		arb2:=Num:C11(Position:C15("Stamps"; [Finished_Goods_Color_SpecMaster:128]finishStamps:14)>0)
		
		drb1:=Num:C11(Position:C15("None"; [Finished_Goods_Color_SpecMaster:128]finishLaminationRMcode:15)>0)
		drb2:=Num:C11(Position:C15("None"; [Finished_Goods_Color_SpecMaster:128]finishLaminationRMcode:15)=0)
	...
	: (Form event code:C388=On Validate:K2:3)
		...
		End if 
		If ([Finished_Goods_Color_SpecMaster:128]Approved:23#Old:C35([Finished_Goods_Color_SpecMaster:128]Approved:23))  //(Modified([Finished_Goods_Color_SpecMaster]Approved))
			QUERY:C277([Finished_Goods:26]; [Finished_Goods:26]ColorSpecMaster:77=[Finished_Goods_Color_SpecMaster:128]id:1)
			If ([Finished_Goods_Color_SpecMaster:128]Approved:23)
				APPLY TO SELECTION:C70([Finished_Goods:26]; [Finished_Goods:26]DateColorApproved:86:=[Finished_Goods_Color_SpecMaster:128]DateReturned:22)
			Else 
