...
Else 
	...
	SELECTION TO ARRAY:C260([Prep_Charges:103]PrepItemNumber:4; $_PrepItemNumber; \
		[Prep_Charges:103]QuantityQuoted:2; $_QuantityQuoted; \
	...
	For ($i; 1; Size of array:C274($_Description))
...
//ORDER SUBRECORDS BY([Finished_Goods_Specifications]Ink;;>)
