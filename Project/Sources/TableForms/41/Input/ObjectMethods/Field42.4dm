...
pendingChange:=pendingChange+"Overrun Changed from "+String:C10(Old:C35([Customers_Order_Lines:41]OverRun:25))+" to "+String:C10([Customers_Order_Lines:41]OverRun:25)+Char:C90(Carriage return:K15:38)
If ([Customers_Orders:40]Status:10="Open@")  //UPR 1188 02/13/ 95 chip
	...
	If (Records in selection:C76([Estimates_Carton_Specs:19])=1)
		If (fLockNLoad(->[Estimates_Carton_Specs:19]))
			[Estimates_Carton_Specs:19]OverRun:47:=Self:C308->
